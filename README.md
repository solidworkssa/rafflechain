# 25-rafflechain - Base Native Architecture
...
RaffleChain provides a decentralized solution for verifiable random raffle draws on both Base (EVM) and Stacks blockchains.
